 ...
 * home indicator. Ported from the design bundle's ios-frame.jsx.
 * Sized to the design's hint-size (430 × 880), dark by default.
 */
...
export function IOSDevice({
  ...
  return (
    <div style={frameStyle}>
      ...
      {/* screen content */}
      <div className="ios-content" style={{ height: '100%', display: 'flex', flexDirection: 'column' }}>
        {children}
      </div>
      {/* home indicator */}
      <div
      ...
      >
        <div
          style={{
            ...
            height: 5,
            borderRadius: 100,
            background: dark ? 'rgba(255,255,255,0.55)' : 'rgba(0,0,0,0.25)',
          }}
        />
      </div>
    </div>
